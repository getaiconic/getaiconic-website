...
const ROUTES = [
  { path: '/',             page: 'home',    title: 'Websites, Missed-Call Text Back, Follow-Up & Booking for Illinois Contractors | AICONIC', desc: 'Done-for-you websites, missed-call text back, lead follow-up, review automation and seasonal campaigns for Illinois plumbers, HVAC, electricians and roofers. Live in 7 to 12 days.' },
  ...
  { path: '/how-it-works', page: 'process', title: 'How It Works: Live in 7 to 12 Days | AICONIC', desc: 'Three short steps from first call to launch. We map where your leads leak, build your booking and follow-up system, and hand you the keys. Live in 7 to 12 days.' },
